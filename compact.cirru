    ...
    |app.config $ %{} :FileEntry
      :defs $ {}
        |*shapes-collection $ %{} :CodeEntry (:doc |)
          :code $ quote
            defatom *shapes-collection $ []
        |adjacent-size $ %{} :CodeEntry (:doc "|put how many pieces together")
          :code $ quote
            def adjacent-size $ js/parseInt (get-env "\"adjacent" "\"5")
        |branch-level $ %{} :CodeEntry (:doc |)
          :code $ quote
            def branch-level $ js/parseInt (get-env "\"level" "\"8")
        |parts $ %{} :CodeEntry (:doc "|corners of each piece")
          :code $ quote
            def parts $ js/parseInt (get-env "\"parts" "\"5")
        |site $ %{} :CodeEntry (:doc |)
          :code $ quote
        ...
        |render-app! $ %{} :CodeEntry (:doc |)
          :code $ quote
            defn render-app! (? arg)
              ...
              js/console.log $ to-js-data @*shapes-collection
      :ns $ %{} :CodeEntry (:doc |)
        :code $ quote
